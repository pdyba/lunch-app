...
def upgrade():
    ...
    op.create_table('ordering_info',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('is_allowed', sa.Boolean(), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
    op.add_column('mail_text_msg', sa.Column('blocked_user_text', sa.String(length=800), nullable=True))
    op.add_column('mail_text_msg', sa.Column('daily_reminder_subject', sa.String(length=200), nullable=True))
    op.add_column('mail_text_msg', sa.Column('ordering_is_blocked_text', sa.String(length=800), nullable=True))
